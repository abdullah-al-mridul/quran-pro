    ...
    <div className="flex h-screen overflow-hidden">
      <aside className="hidden md:flex flex-col w-64 h-full bg-surface-darker border-r border-border-muted z-20">
        ...
        <nav className="flex-1 px-6 py-2 space-y-1 overflow-y-auto">
          ...
          <Link
            className="flex items-center gap-3 px-4 py-2.5 text-slate-500 hover:text-white hover:bg-surface-dark transition-all border border-transparent hover:border-border-muted"
            to="/"
          >
          ...
          <Link
            className="flex items-center gap-3 px-4 py-2.5 bg-primary/10 border border-primary/20 text-white group"
            to="/surahs"
          >
            <MenuBook className="text-accent-gold" style={{ fontSize: 20 }} />
      ...
      <footer className="h-24 bg-surface-darker border-t border-border-muted flex items-center justify-between px-10 z-30 w-full fixed bottom-0 left-0">
        ...
        <div className="flex items-center gap-5 w-1/4">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-3">
              ...
              <span className="text-accent-gold font-arabic text-xs">??</span>
            </div>
        ...
        <div className="flex items-center justify-end gap-6 w-1/4">
          ...
          <div className="flex items-center gap-3">
            ...
            <input
              className="w-20 h-0.5 bg-border-muted appearance-none cursor-pointer"
              max="100"
              min="0"
              type="range"
              defaultValue="70"
